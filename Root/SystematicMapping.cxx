...
SusyNtSys CPsys2sys(const std::string &s)
{
  ...
  else if( s== "TAUS_EFF_CONTJETID_STAT__1down" )          r = PH_SCALE_LEAKAGEUNCONV_UP;
  else if( s== "TAUS_EFF_CONTJETID_STAT__1up" )            r = PH_SCALE_LEAKAGEUNCONV_UP;
  else if( s== "TAUS_EFF_CONTJETID_SYST__1down" )          r = PH_SCALE_LEAKAGEUNCONV_UP;
  else if( s== "TAUS_EFF_CONTJETID_SYST__1up" )            r = PH_SCALE_LEAKAGEUNCONV_UP ;
